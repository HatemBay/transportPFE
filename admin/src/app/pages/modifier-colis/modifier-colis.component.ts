...
@Component({
  selector: "app-modifier-colis",
  templateUrl: "./modifier-colis.component.html",
  styleUrls: ["./modifier-colis.component.scss"],
})
export class ModifierColisComponent implements OnInit {
  ...
  onChanges(): void {
    this.packageForm.get("villeId").valueChanges.subscribe((val) => {
      if (val) this.getDelegations(val);
    });
  }
                  ...
                  this.clientService
                    ...
                    .subscribe((result) => {
                      ...
                      if (
                        ...
                        this.packageForm.value.delegationId ==
                          result[0].delegationId &&
                        this.packageForm.value.villeId == result[0].villeId
                      ) {
